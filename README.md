...
```
├── README.md
├──used-car-price-analysis.ipynb     # Main analysis notebook
...
All three models perform similarly, with Ridge being the recommended choice — it adds regularization to prevent overfitting without sacrificing accuracy, and its coefficients remain interpretable for business insight.
